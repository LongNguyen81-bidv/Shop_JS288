            ...
            <div class="col mb-5">
                <div class="card h-100">
                    ...
                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <div class="text-center">
                        <a class="btn btn-sm btn-outline-dark mt-auto" href="javaScript:void(0)" onclick="addToCart('${item.Ma_so}',3)">Add to cart</a></div>
                    </div>
                </div>
            </div>
            `
...
const xuatSanphamtheoNhom = (maNhom) => {
    ...
    if (maNhom == "ALL") {
        ...
        ds = dsFood.filter(x => x.Nhom.Ma_so.toLowerCase() == maNhom.toLowerCase());
    }
