...
const showModal = (item = null) => {
    ...
    <div class="form-group">
        ...
        <select id="Th_Nhom_Tivi">
            <option value="Tivi" ${Nhom == 'SONY' ? 'selected' : ''} >SONY</option>
            <option value="Tivi" ${Nhom == 'SAMSUNG' ? 'selected' : ''} >SAMSUNG</option>
            <option value="Tivi" ${Nhom == 'LG' ? 'selected' : ''} >LG</option>
            <option value="Tivi" ${Nhom == 'KHAC' ? 'selected' : ''} >KHAC</option>
        </select>
    </div>
    <div class="form-group">
